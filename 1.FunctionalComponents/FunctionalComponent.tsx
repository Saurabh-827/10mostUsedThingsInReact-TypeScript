...
//1. Typing Props with an interface 
                    ...
                    //  (i call it frame😁 for my understanding)


// As you overall structure of this interface ,  same as object right?
interface HelloProps { //here we declared a interface for props 
...
function Hello({name, age}: HelloProps) {  // as you know simple function looks like this Hello() {}
...
const Hello2: React.FC<HelloProps> = function ({ name, age , children}) { //by using function keyword and then removed arrow
